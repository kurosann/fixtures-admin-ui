        ...
        <template #wrapper>
            <el-card class="box-card">
                ...
                <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:appWallet:add']"
                                type="primary"
                                icon="el-icon-plus"
                                size="mini"
                                @click="handleAdd"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:appWallet:edit']"
                                type="success"
                                icon="el-icon-edit"
                                size="mini"
                                :disabled="single"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:appWallet:remove']"
                                type="danger"
                                icon="el-icon-delete"
                                size="mini"
                                :disabled="multiple"
                ...
                <el-table v-loading="loading" :data="appWalletList" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55" align="center"/><el-table-column label="用户Id" align="center" prop="userId"
                                                 :show-overflow-tooltip="true"/><el-table-column label="钱包余额" align="center" prop="walletBalance"
...
<script>
    import {addAppWallet, delAppWallet, getAppWallet, listAppWallet, updateAppWallet} from '@/api/admin/app-wallet'
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                this.loading = true
                listAppWallet(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                        this.appWalletList = response.data.list
