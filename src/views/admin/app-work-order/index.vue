            ...
            <el-card class="box-card">
                <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
                    <el-form-item label="订单ID" prop="orderNo"><el-input v-model="queryParams.orderNo" placeholder="请输入订单ID" clearable
                        ...
                        <el-form-item label="顾客" prop="customer"><el-input v-model="queryParams.customer" placeholder="请输入顾客" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="师傅" prop="masterId"><el-input v-model="queryParams.masterId" placeholder="请输入师傅" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="处理时间" prop="dealTime"><el-input v-model="queryParams.dealTime" placeholder="请输入处理时间" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="估值" prop="valuation"><el-input v-model="queryParams.valuation" placeholder="请输入估值" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="单笔订单流水号" prop="orderFlow"><el-input v-model="queryParams.orderFlow" placeholder="请输入单笔订单流水号" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="实际付款" prop="realPlay"><el-input v-model="queryParams.realPlay" placeholder="请输入实际付款" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="应付款" prop="shouldPlay"><el-input v-model="queryParams.shouldPlay" placeholder="请输入应付款" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="交易类型" prop="dealType"><el-select v-model="queryParams.dealType"
                        ...
                        <el-form-item label="付款凭据" prop="playProof"><el-input v-model="queryParams.playProof" placeholder="请输入付款凭据" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="完成时间" prop="completeTime"><el-input v-model="queryParams.completeTime" placeholder="请输入完成时间" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="订单状态" prop="state"><el-select v-model="queryParams.state"
                        ...
                        <el-form-item label="售后状态" prop="afterState"><el-select v-model="queryParams.afterState"
                ...
                <el-table v-loading="loading" :data="appWorkOrderList" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55" align="center"/><el-table-column label="订单ID" align="center" prop="orderNo"
                                                 :show-overflow-tooltip="true"/><el-table-column label="顾客" align="center" prop="customer"
                                                 :show-overflow-tooltip="true"/><el-table-column label="师傅" align="center" prop="masterId"
                                ...
                                </el-table-column><el-table-column label="估值" align="center" prop="valuation"
                                                 :show-overflow-tooltip="true"/><el-table-column label="单笔订单流水号" align="center" prop="orderFlow"
                                                 :show-overflow-tooltip="true"/><el-table-column label="实际付款" align="center" prop="realPlay"
                                                 :show-overflow-tooltip="true"/><el-table-column label="应付款" align="center" prop="shouldPlay"
                                                 :show-overflow-tooltip="true"/><el-table-column label="交易类型" align="center" prop="dealType"
                                                 :formatter="dealTypeFormat" width="100">
                                    <template slot-scope="scope">
                                        {{ dealTypeFormat(scope.row) }}
                                    </template>
                                </el-table-column><el-table-column label="付款凭据" align="center" prop="playProof"
                                ...
                                </el-table-column><el-table-column label="订单状态" align="center" prop="state"
                                                 :formatter="stateFormat" width="100">
                                    <template slot-scope="scope">
                                        {{ stateFormat(scope.row) }}
                                    </template>
                                </el-table-column><el-table-column label="售后状态" align="center" prop="afterState"
...
<script>
    import {addAppWorkOrder, delAppWorkOrder, getAppWorkOrder, listAppWorkOrder, updateAppWorkOrder} from '@/api/admin/app-work-order'
