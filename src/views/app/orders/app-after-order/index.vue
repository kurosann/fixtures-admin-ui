        ...
        <template #wrapper>
            <el-card class="box-card">
                <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
                    <el-form-item label="售后单号" prop="afterNo"><el-input v-model="queryParams.afterNo" placeholder="请输入售后单号" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="处理订单号" prop="orderNo"><el-input v-model="queryParams.orderNo" placeholder="请输入处理订单号" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="支付流水号" prop="payNo"><el-input v-model="queryParams.payNo" placeholder="请输入支付流水号" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="售后类型" prop="afterType"><el-input v-model="queryParams.afterType" placeholder="请输入售后类型" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="提交人" prop="dealByUser"><el-input v-model="queryParams.dealByUser" placeholder="请输入提交人" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="处理时间" prop="dealTime"><el-input v-model="queryParams.dealTime" placeholder="请输入处理时间" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="审核时间" prop="auditTime"><el-input v-model="queryParams.auditTime" placeholder="请输入审核时间" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="售后状态" prop="state"><el-select v-model="queryParams.state"
                ...
                <el-table v-loading="loading" :data="appAfterOrderList" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55" align="center"/><el-table-column label="售后单号" align="center" prop="afterNo"
                                                 :show-overflow-tooltip="true"/><el-table-column label="处理订单号" align="center" prop="orderNo"
                                                 :show-overflow-tooltip="true"/><el-table-column label="支付流水号" align="center" prop="payNo"
                                                 :show-overflow-tooltip="true"/><el-table-column label="售后类型" align="center" prop="afterType"
                                                 :show-overflow-tooltip="true"/><el-table-column label="售后原因" align="center" prop="reasion"
                                                 :show-overflow-tooltip="true"/><el-table-column label="处理类型" align="center" prop="dealType"
                                                 :formatter="dealTypeFormat" width="100">
                                    <template slot-scope="scope">
                                        {{ dealTypeFormat(scope.row) }}
                                    </template>
                                </el-table-column><el-table-column label="提交人" align="center" prop="dealByUser"
                                                 :show-overflow-tooltip="true"/><el-table-column label="标的款" align="center" prop="tagPrice"
                                                 :show-overflow-tooltip="true"/><el-table-column label="补贴" align="center" prop="subsidy"
                                                 :show-overflow-tooltip="true"/><el-table-column label="实付款" align="center" prop="realPrice"
                                                 :show-overflow-tooltip="true"/><el-table-column label="处理时间" align="center" prop="dealTime"
                                                 :show-overflow-tooltip="true">
                                    <template slot-scope="scope">
                                    <span>{{ parseTime(scope.row.dealTime) }}</span>
                                    </template>
                                </el-table-column><el-table-column label="支付进度" align="center" prop="planNums"
                                                 :show-overflow-tooltip="true"/><el-table-column label="进程天数" align="center" prop="planDay"
                                                 :show-overflow-tooltip="true"/><el-table-column label="进程总天数" align="center" prop="totalDay"
                                                 :show-overflow-tooltip="true"/><el-table-column label="工程天数" align="center" prop="workDay"
                                                 :show-overflow-tooltip="true"/><el-table-column label="处理备注" align="center" prop="dealRemark"
                                                 :show-overflow-tooltip="true"/><el-table-column label="审核人" align="center" prop="auditByUser"
                                                 :show-overflow-tooltip="true"/><el-table-column label="审核时间" align="center" prop="auditTime"
                                                 :show-overflow-tooltip="true">
                                    <template slot-scope="scope">
                                    <span>{{ parseTime(scope.row.auditTime) }}</span>
                                    </template>
                                </el-table-column><el-table-column label="售后状态" align="center" prop="state"
...
<script>
    import {addAppAfterOrder, delAppAfterOrder, getAppAfterOrder, listAppAfterOrder, updateAppAfterOrder} from '@/api/admin/app-after-order'
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 表单校验
                rules: {afterNo:  [ {required: true, message: '售后单号不能为空', trigger: 'blur'} ],
